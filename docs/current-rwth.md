...
- Authoritative version: read `@version` / `SCRIPT_VERSION` in the script itself. Do not restate the number here — a hand-copied version only rots (it sat at 0.3.144 while the script shipped 0.3.152).
